-- ShiftSync V2 seed for Supabase SQL editor
-- Run AFTER V1__schema.sql
-- Password for all users: password (BCrypt cost 12)
--
-- Deterministic UUIDs (valid for Postgres UUID columns):
--   site  a0000000-0000-4000-8000-000000000001
--   dept  b0000000-0000-4000-8000-00000000000N
--   cert  c0000000-0000-4000-8000-00000000000N
--   user  dN000000-0000-4000-8000-00000000000N
